    ...
    if(isset($_GET['action'])){
        ...
        if($_GET['action']=="assignRider") 
        {
            ...
            if($json_data['code'] == "200")
            {
                ...
                echo "<script>window.location='dashboard.php?p=assignOrder&status=all&action=success'</script>";
            }
            else
            {
                echo "<script>window.location='dashboard.php?p=assignOrder&status=all&action=error'</script>";
            }
        }
        ...
        if($_GET['action']=="acceptOrder") 
        {
            ...
            if($json_data['code'] == "200")
            {
                ...
                echo "<script>window.location='dashboard.php?p=assignOrder&status=0&action=success'</script>";
            }
            else
            {
                echo "<script>window.location='dashboard.php?p=assignOrder&status=0&action=error'</script>";
            }
        }
